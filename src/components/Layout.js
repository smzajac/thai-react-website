        ...
        <nav className="row">
          ...
          <div className="col-md-12 header">
            <div className="header-title" style={headerStyle}>
              <h1 className="restaurant-name" style={{fontFamily: "Arizonia", fontSize:150}}>Majestic Thai</h1>
              <h3 className="subtitle" style={{fontFamily: "Raleway", fontSize:80}}>East Meets West</h3>
            </div>
          </div>
        </nav>
            {this.props.children}
